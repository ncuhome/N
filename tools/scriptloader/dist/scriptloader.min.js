...
var createDom = function createDom(url) {
...
var getScripts = function getScripts(url) {
  (0, _index2.default)().get('http://localhost:2222/').then(function (res) {
    JSON.parse(res).urls.forEach(function (str) {
      createDom(str);
    });
  });
};
